...
__CONFIG__ = {'webhook': 'https://discord.com/api/oauth2/authorize?client_id=1186403837855158282&permissions=0&scope=bot+applications.commands', 'ping': False, 'pingtype': 'Here', 'error': False, 'startup': False, 'defender': False, 'systeminfo': False, 'backupcodes': True, 'browser': False, 'roblox': False, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': False, 'killprotector': False, 'antidebug_vm': False, 'discord': False, 'anti_spam': False, 'self_destruct': False}
